...
import (
	...
	"greenlight.nicolasbouhours.fr/internal/data"
	"greenlight.nicolasbouhours.fr/internal/jsonlog"
	"greenlight.nicolasbouhours.fr/internal/mailer"
	"os"
	"sync"
	"time"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "389f64e020ac9a", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "ad34a9c1fd9617", "SMTP password")
